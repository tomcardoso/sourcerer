...
export const CONTACTS_4: SeedContact[] = [
  ...
  },
  {
    ...
    phones: ['+1 582 555 7214', '+1 582 555 7261'],
    links: [
      { type: 'linkedin', url: 'https://linkedin.com/in/anne-robertson-govrel' },
      { type: 'website', url: 'https://robertsongovernmentrelations.example' },
    ],
  },
  {
    name: 'Anne Robinson',
  ...
  },
  {
    ...
    notes: null,
    emails: ['e.beaupre@bfcomm.example'],
    phones: ['+1 438 555 7891'],
  ...
  },
  {
    ...
    phones: ['+1 582 555 7904'],
    links: [],
  },
  {
    name: 'Zach Pendergast',
    organization: 'The National Chronicle — Provincial Legislature Bureau',
    notes: null,
    emails: ['z.pendergast@nationalchronicle.example'],
    phones: ['+1 363 555 8011'],
    links: [
      { type: 'x', url: 'https://x.com/zpendergast_nc' },
  ...
  },
  {
    ...
    phones: ['+1 363 555 8247'],
    links: [
      { type: 'linkedin', url: 'https://linkedin.com/in/finlay-drummond' },
      { type: 'x', url: 'https://x.com/finlaydrummond' },
      { type: 'website', url: 'https://transparencywatch.example' },
    ],
  },
  {
  ...
  },
  {
    ...
    phones: ['+1 363 555 8694', '+1 363 555 8741'],
    links: [{ type: 'linkedin', url: 'https://linkedin.com/in/callum-forsythe' }],
  },
  {
    ...
    phones: ['+1 582 555 8812'],
    links: [
      { type: 'linkedin', url: 'https://linkedin.com/in/dana-przybylski' },
      { type: 'x', url: 'https://x.com/dana_fij' },
    ],
  },
  {
  ...
  },
  {
    ...
    organization: 'Beaumont Devereux LLP — Capital',
    notes: null,
    emails: ['sandra.hutchings@beaudev.example'],
    phones: ['+1 582 555 8927'],
